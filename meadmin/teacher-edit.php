			...
			<div class="tables">
				...
				<table class="table table-bordered ">
					...
					<tbody>
						...
						<?php $teacher_dis_admin = $paras->teacher_info_display_admin();
													$t_sn = 1;
				...
				<a href="home.php?paras=teacher-editnow&teacherid=<?php echo $teacher_info_admin['t_id']; ?>" class="btn red">Edit</a>
					</td>
						</tr>
						<?php $t_sn++; } ?>
					</tbody>
