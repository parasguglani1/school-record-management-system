...
else
{
	...
	$meadmin_username = $paras->meadmin_username($adminname);
	...
	$info = $paras->teacher_info($adminname,$t_staff_type);
	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="inner-content">
				...
				<footer>
				<p>&copyright 2021 All Rights Reserved Design by Paras,prateek,Rohan,Rohit</p>
				</footer>
				<!--footer section end-->
			</div>
		</div>
		...
		<div class="sidebar-menu">
			...
			<div class="down">
				...
				<p>System Administrator in RiverView</p>
				<ul>
				...
				<ul id="menu">
					...
					<li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span>Students</span> <span class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="home.php?paras=student-information">Students Information</a></li>
							<li id="menu-academico-boletim"><a href="home.php?paras=add-student">Add Students</a></li>
					...
					<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="home.php?paras=teacher-information">Teacher Information</a></li>
							<li id="menu-academico-avaliacoes"><a href="home.php?paras=teacher-edit">Edit Teacher</a></li>
							<li id="menu-academico-boletim"><a href="home.php?paras=teacher-add">Add Teacher</a></li>
							<li id="menu-academico-avaliacoes"><a href="home.php?paras=teacher-delete">Delete Teacher</a></li>
